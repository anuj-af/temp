...
const Register = () => {
    ...
    const requestOtp = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:8000/user/send-otp', { phone_no: phoneNumber });
    ...
    const handleOtpSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:8000/user/verify-otp', { phone_no: phoneNumber, enteredOtp: otp, otpToken: otpToken });
    ...
    const handleFinalSubmit = async () => {
        try {
            const response = await axios.post('http://localhost:8000/user/register', {
                ...
                enteredOtp: otp, // Include the OTP
                otpToken: otpToken
            });
            alert('Registration successful');
            navigate('/student/form'); // Redirect to desired route
        } catch (error) {
